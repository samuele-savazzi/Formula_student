...
#include "first_project/listener.hpp"  
...
void Listener::ping_callback(const interfacce::msg::Call::SharedPtr msg) const      
{
    if(id==msg->id){
...
void Listener::call_callback(const interfacce::msg::Call::SharedPtr msg) const      
{
    if(msg->id==0){
